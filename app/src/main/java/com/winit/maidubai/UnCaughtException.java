...
public class UnCaughtException implements UncaughtExceptionHandler {
    private static final String RECIPIENT = "digen@winitsoftware.com,vinod.kumar@winitsoftware.com";
    ...
    public void sendErrorMail(final StringBuilder errorContent) {
        ...
        new Thread() {
            ...
            public void run() {
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent sendIntent = new Intent(
                                        Intent.ACTION_SEND);
                                String subject = "WINIT MaiDubai Log. MaiDubai";
                ...
                builder.setMessage("Sorry for inconvenience. MaiDubai app stopped working.");
