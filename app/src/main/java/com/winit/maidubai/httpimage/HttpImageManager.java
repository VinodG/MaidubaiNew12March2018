...
package com.winit.maidubai.httpimage;
            ...
            public void run() {
                ...
                synchronized (mActiveRequests) {
                    ...
                    while (mActiveRequests.contains(request)) {
                        ...
                        } catch(InterruptedException e) {  throw new RuntimeException("This can never happen", e);}
                    }
                            ...
                            try {
                                try {
                                    ...
                                    if(responseStream==null){
                                        responseStream = new HttpHelper().sendRequest(request.path, ServiceUrls.METHOD_GET, null, null);
                                    }
                                }
                                if(responseStream!=null){
...
//                                         data = BitmapUtil.decodeByteArray(binary, mMaxNumOfPixelsConstraint);
                                ...
                                if(responseStream != null) {
                                    try { responseStream.close(); } catch (IOException e) {  throw new RuntimeException("This can never happen", e);}
                                }
                            }
                            ...
                            if (mFilter != null) {
                                ...
                                catch (Throwable e) {  throw new RuntimeException("This can never happen", e);}
                            }
                            // load it into memory
                            if (mCache != null)
                                mCache.storeData(key, data);
...
//        }
    ...
    private void fireLoadResponse(final LoadRequest r, final Bitmap image) {
        if ( r.mListener != null) {
            ...
            }catch (Exception e){                  throw new RuntimeException("This can never happen", e);}
...
//            catch (Throwable t) {}
    ...
    private void fireLoadFailure(final LoadRequest r, final Throwable e) {
        if ( r.mListener != null) {
            ...
            catch (Throwable t) {  throw new RuntimeException("This can never happen", e);}
        }
    }
